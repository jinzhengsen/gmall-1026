...
public class SpuController {
    ...
    public ResponseVo<PageResultVo> querySpuByCid(PageParamVo paramVo,@PathVariable("categoryId") Long cid){
        PageResultVo pageResultVo=spuService.querySpuByCid(paramVo,cid);
