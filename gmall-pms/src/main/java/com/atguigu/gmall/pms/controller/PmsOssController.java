...
public class PmsOssController {
    ...
    String accessId = "LTAI4G2sHrmZrxn1C6G542jr"; // 请填写您的AccessKeyId。
    String accessKey = "6jl5Tby6G3y5HaMvLFD7GgI2N7UX8s"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-shanghai.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "gmall1026"; // 请填写您的 bucketname 。
